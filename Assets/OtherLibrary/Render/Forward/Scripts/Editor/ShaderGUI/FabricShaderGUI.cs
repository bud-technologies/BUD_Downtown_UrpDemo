    ...
    public class FabricShaderGUI : CommonShaderGUI
    {
        ...
        FabricType DrawFabricType(Material material)
        {
            ...
            if (fabricProb != null)
            {
                ...
                return (FabricType)material.GetInt("_Silk");
            }
            return 0;
        }
        ...
        void DrawSkinGUI(MaterialEditor materialEditor, Material material)
        {
            ...
            materialEditor.TexturePropertySingleLine(EditorGUIUtility.TrTextContent("法线贴图"), normal, FindMaterialProperty("_BumpScale"));
            ...
            // Mask Map
            base.DrawPropertyTexture(FindMaterialProperty("_MetallicGlossMap"), "PBR遮罩");
