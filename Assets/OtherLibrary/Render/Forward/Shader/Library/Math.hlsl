...
//
//rgbColor:要调整亮度的RGB颜色
//multiple:调整倍数
half3 RGBIntensityControl(half3 rgbColor,float multiple){
    half3 hsvColor = RGBtoHSV(rgbColor);
    //色相调整
...
half LuminanceUE(half3 LinearColor)
{
