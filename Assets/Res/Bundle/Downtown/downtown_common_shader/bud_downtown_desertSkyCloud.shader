...
Shader "bud/downtown/desertSkyCloud"
{
	Properties
	{
		...
		[Toggle(_USE_SSSCOLOR_ON)] _Use_SSSColor("Use_SSSColor", Float) = 0
		...
		_Tiling1_Offset("Tiling1_Offset", Vector) = (0,0,0,0)
		_SecondAlphaMin("SecondAlphaMin", Range( -1 , 1)) = 1
		_Tiling2_Offset("Tiling2_Offset", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local _USE_SSSCOLOR_ON
			...
			half4 _CloudColor;
			half4 _SSSColor;
			half2 _Tiling1_Offset;
			half2 _Tiling2_Offset;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#ifdef _USE_SSSCOLOR_ON
				half staticSwitch157 = SSSOutPut69;
				#else
				half staticSwitch157 = 0.0;
				#endif
				half4 lerpResult106 = lerp( _CloudColor , _SSSColor , staticSwitch157);
				...
				half2 texCoord126 = IN.ase_texcoord3.xy * temp_cast_1 + _Tiling1_Offset;
				half smoothstepResult153 = smoothstep( _SecondAlphaMin , _SecondAlphaMax , tex2D( _TextureSecondNoise, texCoord126 ).r);
				half2 temp_cast_2 = (_Tiling2).xx;
				half2 texCoord127 = IN.ase_texcoord3.xy * temp_cast_2 + _Tiling2_Offset;
				half smoothstepResult152 = smoothstep( _MainAlphaMin , _MainAlphaMax , tex2D( _TextureMainNoise, texCoord127 ).r);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 texCoord126 = IN.ase_texcoord2.xy * temp_cast_0 + _Tiling1_Offset;
				half smoothstepResult153 = smoothstep( _SecondAlphaMin , _SecondAlphaMax , tex2D( _TextureSecondNoise, texCoord126 ).r);
				half2 temp_cast_1 = (_Tiling2).xx;
				half2 texCoord127 = IN.ase_texcoord2.xy * temp_cast_1 + _Tiling2_Offset;
				half smoothstepResult152 = smoothstep( _MainAlphaMin , _MainAlphaMax , tex2D( _TextureMainNoise, texCoord127 ).r);
				half temp_output_139_0 = ( smoothstepResult153 * smoothstepResult152 );
				half smoothstepResult147 = smoothstep( 0.0 , 1.0 , temp_output_139_0);
				half AlphaCloud20 = smoothstepResult147;
...
/*ASEBEGIN
Version=18912
2564;166;1440;990;665.2227;555.7183;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;155;-3291.151,-228.894;Inherit;False;Property;_Tiling1_Offset;Tiling1_Offset;16;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;124;-3391.353,-303.1462;Inherit;False;Property;_Tiling1;Tiling1;9;0;Create;True;0;0;0;False;0;False;1;5.5;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-3386.586,18.10678;Inherit;False;Property;_Tiling2;Tiling2;10;0;Create;True;0;0;0;False;0;False;1;5.79;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;156;-3286.086,95.24915;Inherit;False;Property;_Tiling2_Offset;Tiling2_Offset;18;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;127;-3081.577,27.30466;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;126;-3080.822,-300.1682;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-2728.849,279.9078;Inherit;False;Property;_MainAlphaMax;MainAlphaMax;13;0;Create;True;0;0;0;False;0;False;-1;0.596;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;137;-2748.303,20.86342;Inherit;True;Property;_TextureMainNoise;TextureMainNoise;7;0;Create;True;0;0;0;False;0;False;-1;0664a1da46c851d4f9a6991af9897489;6c3225b7078344542abbcf8b36e5eec5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LengthOpNode;5;-2317.064,-677.4438;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;148;-2728.849,207.9076;Inherit;False;Property;_MainAlphaMin;MainAlphaMin;11;0;Create;True;0;0;0;False;0;False;-1;0.412;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;150;-2728.949,-50.4199;Inherit;False;Property;_SecondAlphaMax;SecondAlphaMax;19;0;Create;True;0;0;0;False;0;False;1;0.55;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-2454.064,-592.4435;Inherit;False;Property;_FadeDistance;FadeDistance;1;0;Create;True;0;0;0;False;0;False;350;961;350;10000;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;138;-2747.543,-311.1709;Inherit;True;Property;_TextureSecondNoise;TextureSecondNoise;15;0;Create;True;0;0;0;False;0;False;-1;7c8dbfb9b07443e45ad8604fd1906926;6c3225b7078344542abbcf8b36e5eec5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;149;-2727.949,-125.4199;Inherit;False;Property;_SecondAlphaMin;SecondAlphaMin;17;0;Create;True;0;0;0;False;0;False;1;0.293;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-2454.064,-515.4433;Inherit;False;Property;_FadeContrast;FadeContrast;2;0;Create;True;0;0;0;False;0;False;1;4.77;0.1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;132;-2156.29,-209.5152;Inherit;False;Property;_Float2;Float 2;12;0;Create;True;0;0;0;False;0;False;0.1294118;0.166;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-2074.78,755.4152;Inherit;False;Property;_SSSConcentration;SSSConcentration;6;0;Create;True;0;0;0;False;0;False;0.6;1.97;0.6;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;130;-2156.29,-134.515;Inherit;False;Property;_Float3;Float 3;14;0;Create;True;0;0;0;False;0;False;0.5058824;0.726;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;106;-150.8233,-156.2862;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;109;-624.0534,-253.0738;Inherit;False;Property;_SSSColor;SSSColor;4;0;Create;True;0;0;0;False;0;False;0.6509434,0.3039783,0.3039783,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;157;-390.5933,-47.93799;Inherit;False;Property;_Use_SSSColor;Use_SSSColor;3;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2075.628,835.7711;Inherit;False;Property;_SSSColorBrightness;SSSColorBrightness;5;0;Create;True;0;0;0;False;0;False;0.6;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;70;-586.7648,10.70917;Inherit;False;69;SSSOutPut;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;158;-548.5933,-72.93799;Inherit;False;Constant;_Float0;Float 0;20;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;16;-622.6057,-431.9471;Inherit;False;Property;_CloudColor;CloudColor;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9957377,1,0.854902,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;160;2;106;0
WireConnection;160;3;117;0
ASEEND*/
//CHKSM=0EA2EA26E94E86B0B4ED00A276C20F25512DC28D