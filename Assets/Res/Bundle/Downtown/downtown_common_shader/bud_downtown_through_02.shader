...
Shader "bud/downtown/through_02"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _Color * tex2DNode1 ).rgb;
				float Alpha = tex2DNode1.a;
				float AlphaClipThreshold = tex2DNode1.a;
...
/*ASEBEGIN
Version=18912
2560;0;2560;1371;1533.114;500.2672;1;True;False
