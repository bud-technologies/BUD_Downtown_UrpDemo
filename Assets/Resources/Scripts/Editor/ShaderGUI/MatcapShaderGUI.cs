...
namespace NewRenderShaderGUI
{
    public class MatcapShaderGUI : BaseShaderGUI
    {
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            m_NormalMapProp = FindProperty("_BumpMap", properties);
            m_NormalScaleProp = FindProperty("_BumpScale", properties);
        ...
        public override void SetupMaterialKeywords(Material material)
        {
            ...
            material.SetKeyword("_MATCAP_ON", m_MatcapMapProp.textureValue != null);
            material.SetKeyword("_NORMAL_ON", m_NormalMapProp.textureValue != null);
            material.SetKeyword("_NORMAL_ANIMATION_ON", m_NormalAnimToggleProp.floatValue != 0);
