...
// half3 LightingUnityFabric_Unity(SurfaceData_Fabric fabricSurfaceData, BSDFData_Fabric bsdfData, InputData_Fabric inputData, PreLightData_Fabric preLightData)
// {
...
//     Light mainLight = GetMainLight_SGame(inputData.positionWS,inputData.positionCS,inputData.shadowCoord,shadowMask);
